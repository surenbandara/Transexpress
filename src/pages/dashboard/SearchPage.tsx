...
const SearchPageDashboard: React.FC = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        {filteredOrders && (
          <>
            {renderSection('Pending', filteredOrders.pending)}
            {renderSection('Delivering', filteredOrders.delivering)}
          </>
        )}
        {!filteredOrders || 
        (
         filteredOrders.pending.length === 0 &&
         filteredOrders.delivering.length === 0) && (
...
export default SearchPageDashboard;
